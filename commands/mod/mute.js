          ...
          try {
            mutee.roles.set([muterole.id]).then(() => {
                ...
                const sembed = new MessageEmbed()
                    ...
                    .setDescription(`<:896365430841679882:914642292441231360> **| ${mutee.user.username} was successfully muted for ${reason}**`)
                message.channel.send(sembed);
                } else {
                    const sembed2 = new MessageEmbed()
                    .setColor("2f3136")
                    .setDescription(`<:896365430841679882:914642292441231360> **| ${mutee.user.username} was successfully muted**`)
