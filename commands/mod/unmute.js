...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if (!message.member.hasPermission("MANAGE_GUILD")) return message.channel.send("<:896365442925482025:914642294752301057> | ** You Dont Have The Permissions To Unmute Someone!**");

        if (!message.guild.me.hasPermission("MANAGE_GUILD")) return message.channel.send("**<:896365442925482025:914642294752301057> I Don't Have Permissions To Unmute Someone!**")
        ...
        if (!mutee) return message.channel.send('**Enter User**');
        ...
        mutee.roles.remove(muterole.id).then(() => {
            mutee.send(`**You Have Been Unmuted In ${message.guild.name} for ${reason || "No Reason"}**`).catch(() => null)
            ...
            const sembed = new MessageEmbed()
                .setColor("2f3136")
                .setDescription(`${mutee.user.username} <:896365430841679882:914642292441231360> was successfully unmuted.`)
