...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        .setDescription("<:896365442925482025:914642294752301057> **| Sorry, you don't have permissions to use this!**")
            ...
            member.send(`<:896365430841679882:914642292441231360> **| You have been warned by <${message.author.username}> for this reason: ${reason}**`)
            .catch(error => message.channel.send(`<:896365442925482025:914642294752301057> **| Sorry <${message.author}> I couldn't warn because of : ${error}**`));
