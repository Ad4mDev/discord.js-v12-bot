const { Client, MessageActionRow, MessageButton, MessageAttachment, Collection, MessageEmbed } = require('discord.js');
...
bot.on('message', async message => {
    ...
    if (!isNaN(messages)) {
        ...
        message.channel.send(`🎉 ${message.author}, you've reached **level ${levelfetch}!** 🎉`);
    };
});
